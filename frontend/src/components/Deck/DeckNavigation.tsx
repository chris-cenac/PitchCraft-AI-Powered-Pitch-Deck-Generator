...
const DraggableSlide: React.FC<DraggableSlideProps> = ({
  ...
  return (
    <div
      ref={ref}
      className={`flex items-center justify-center w-8 h-8 font-bold text-xs rounded-full cursor-move transition bg-surface dark:bg-surface-dark border border-transparent hover:border-primary dark:hover:border-accent ${
        isActive
